...
const getColourHex = function (colour) {
	return enums.ColourHexes[colour];
};
// Return text version of landscape
const getLandscapeName = function (landscape) {
	switch (landscape) {
		case enums.Landscape.TEMPERATE:
			return 'Temperado';
		case enums.Landscape.ARCTIC:
			return 'Subártico';
		case enums.Landscape.TROPIC:
			return 'Subtropical';
		case enums.Landscape.TOYLAND:
			return 'Terra dos xoguetes';
	}
};
